...
<p align="center">
  <img src="framework_phase2.drawio.png" alt="IR2025 Phase 2 Framework Diagram" width="700"/>
</p>
...
Η προεπεξεργασία στοχεύει στον βασικό καθαρισμό κειμένου και στην ομογενοποίηση IDs.
